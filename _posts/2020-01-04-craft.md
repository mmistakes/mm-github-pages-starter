...
tags:
  ...
  - ssh
---
![](/assets/images/htb/craft/info-card.png)

## Quick Summary

So!!
Today was just retired Craft from Hack the box, this was a really fun box to do, and also I felt pretty well doing it, because even if I needed some nudges, it was actually the first box I got to the foothold without hints (elsen if I needed some guidance with python, thanks a lot @Frundrod!!), and afterwards to get user I was a bit lost and also needed some hints (was not realizing something I have litteraly in my nose, thankss a lot @Fugl!), root was easy by a little bit of enumeration and reading help command output.
...
![](/assets/images/htb/craft/1-web-enum.png)
![](/assets/images/htb/craft/2-web-enum.png)
Afterwards, we jump into `https://api.craft.htb` and we can see the endpoints and how to interact with them.
![](/assets/images/htb/craft/1-api.png)
![](/assets/images/htb/craft/2-api.png)
![](/assets/images/htb/craft/3-api.png)
...
![](/assets/images/htb/craft/1-gogs.png)
![](/assets/images/htb/craft/2-gogs.png)
![](/assets/images/htb/craft/3-gogs.png)
...
![](/assets/images/htb/craft/7-gogs.png)
...
There is something weird, we already root? we check if there is the `root.txt` in it's home and not, is not:
...
![](/assets/images/htb/craft/1-rce.png)
...
![](/assets/images/htb/craft/1-gil.png)
![](/assets/images/htb/craft/2-gil.png)
We notice there is a `.ssh` folder, we look into it and we get a pair of public/private ssh keys:
![](/assets/images/htb/craft/3-gil.png)
...
![](/assets/images/htb/craft/4-gil.png)
...
And we own root!!
Again I enjoyed quite a lot doing this box a few hours it was going to be retired, and again thanks again @Frundrod and @Fugl for point me in the right direction.
