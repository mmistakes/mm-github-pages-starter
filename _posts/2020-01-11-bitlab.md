...
This was a cool box, not hard at the technical level, but one which required to do enumeration, enumeration and more enumeration to get the juicy flags, so excellent box to try that!
