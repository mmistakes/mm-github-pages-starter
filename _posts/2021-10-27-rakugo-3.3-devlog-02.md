...
**RakugoTextLabel** was separated from **Rakugo** and turned into ➡️ **[AdvancedTextLabel]**. It's a new node that will be used in for displaying text in **Rakugo's** GUI templates.
...
About Markdown support: **AdvancedTextLabel** use **RichTextLabel** as base for it we only can do what Godot's **BBCode** supports. So it is a bit different from standard **Markdown**.
